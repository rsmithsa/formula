...
type FinancialFunctionsTests () =
    ...
    member this.TestFinancialFunctionDdb () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(20000.0); Number(8000.0); Number(5.0); Number(1.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(20000.0); Number(8000.0); Number(5.0); Number(1.0); Number(2.0)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(20000.0); Number(8000.0); Number(5.0); Number(1.0) |])]))
        Assert.AreEqual((false, "DDB expects four or five arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(20000.0); Number(8000.0); Number(5.0) |])]))
    ...
    member this.TestFinancialFunctionFv () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(10.0); Number(1000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(10.0); Number(1000.0); Number(1000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(10.0); Number(1000.0); Number(1000.0); Number(0.0)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0); Number(1000.0) |])]))
        Assert.AreEqual((false, "FV expects three, four or five arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0) |])]))
    ...
    member this.TestFinancialFunctionIpmt () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(3.0); Number(10.0); Number(1000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(3.0); Number(10.0); Number(1000.0); Number(1000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(3.0); Number(10.0); Number(1000.0); Number(1000.0); Number(0.0)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(3.0); Number(10.0); Number(1000.0) |])]))
        Assert.AreEqual((false, "IPMT expects four, five or six arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0) |])]))
    ...
    member this.TestFinancialFunctionIrr () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(-100000.0); Number(105000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(-100000.0); Number(105000.0); Number(5000.0)]))
        Assert.AreEqual((false, "IRR expects at least three arguments."), functionImplementation.Validate (List.toArray []))
        Assert.AreEqual((false, "IRR expects at least three arguments."), functionImplementation.Validate (List.toArray [Number(0.1)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); ValueArray([| Number(-100000.0); Number(105000.0) |])]))
        Assert.AreEqual((false, "IRR expects at least three arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(-100000.0) |])]))
    ...
    member this.TestFinancialFunctionMirr () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(0.1); Number(-100000.0); Number(105000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(0.1); Number(-100000.0); Number(105000.0); Number(5000.0)]))
        Assert.AreEqual((false, "MIRR expects at least four arguments."), functionImplementation.Validate (List.toArray []))
        Assert.AreEqual((false, "MIRR expects at least four arguments."), functionImplementation.Validate (List.toArray [Number(0.1)]))
        Assert.AreEqual((false, "MIRR expects at least four arguments."), functionImplementation.Validate (List.toArray [Number(0.1); Number(0.1)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(0.1); ValueArray([| Number(-100000.0); Number(105000.0) |])]))
        Assert.AreEqual((false, "MIRR expects at least four arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(0.1); Number(-100000.0) |])]))
    ...
    member this.TestFinancialFunctionNper () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0); Number(1000.0) |])]))
        Assert.AreEqual((false, "NPER expects three, four or five arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0) |])]))
    ...
    member this.TestFinancialFunctionNpv () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(-100000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(-100000.0); Number(10000.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(0.1); Number(-100000.0); Number(10000.0); Number(10000.0)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(-100000.0) |])]))
        Assert.AreEqual((false, "NPV expects at least two arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1) |])]))
    ...
    member this.TestFinancialFunctionPmt () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0); Number(1000.0) |])]))
        Assert.AreEqual((false, "PMT expects three, four or five arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0) |])]))
    ...
    member this.TestFinancialFunctionPpmt () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(3.0); Number(10.0); Number(1000.0) |])]))
        Assert.AreEqual((false, "PPMT expects four, five or six arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0) |])]))
    ...
    member this.TestFinancialFunctionPv () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0); Number(1000.0) |])]))
        Assert.AreEqual((false, "PV expects three, four or five arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(0.1); Number(10.0) |])]))
    ...
    member this.TestFinancialFunctionRate () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(10.0); Number(-100.0); Number(800.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(10.0); Number(-100.0); Number(800.0); Number(100.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(10.0); Number(-100.0); Number(800.0); Number(100.0); Number(1.0)]))
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(10.0); Number(-100.0); Number(800.0); Number(100.0); Number(1.0); Number(0.2)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(10.0); Number(-100.0); Number(800.0) |])]))
        Assert.AreEqual((false, "RATE expects three, four, five or six arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(10.0); Number(-100.0) |])]))
    ...
    member this.TestFinancialFunctionSln () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(10000.0); Number(1000.0); Number(5.0)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(10000.0); Number(1000.0); Number(5.0) |])]))
        Assert.AreEqual((false, "SLN expects three arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(10000.0); Number(1000.0) |])]))
    ...
    member this.TestFinancialFunctionSyd () =
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [Number(10000.0); Number(1000.0); Number(5.0); Number(1.0)]))
        ...
        Assert.AreEqual((true, (null: string)), functionImplementation.Validate (List.toArray [ValueArray([| Number(10000.0); Number(1000.0); Number(5.0); Number(1.0) |])]))
        Assert.AreEqual((false, "SYD expects four arguments."), functionImplementation.Validate (List.toArray [ValueArray([| Number(10000.0); Number(1000.0); Number(5.0) |])]))
