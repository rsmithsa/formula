...
type IVariableProvider =
    ...
    abstract member LookupRange: name: string * range: (value * value) -> value[]
    abstract member LookupRange: name: string * range: (value * value) * sender: IVariableProvider -> value[]